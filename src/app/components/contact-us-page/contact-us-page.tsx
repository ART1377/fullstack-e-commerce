...
const ContactUsPage = (props: Props) => {
  return (
    <section className="w-full mt-4 sm:mt-10 flex flex-col gap-y-8 bg-primary-100 rounded-xl py-8 px-2 sm:px-4 sm:flex-row-reverse sm:justify-between items-center relative">
