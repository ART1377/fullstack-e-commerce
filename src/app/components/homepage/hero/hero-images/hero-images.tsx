...
//       <Link
//         href={`products/${products[current].id}`}
//         className="w-1/2 aspect-square relative bg-primary-light rounded-full h-fit my-auto overflow-hidden"
//       >
//         <motion.div
//           key={products[current].id}
//           variants={getSlideInVariant(current)} // Dynamically set animation based on the index
...
//             className={`${
//               current === index ? "bg-primary-main" : "bg-primary-light"
//             } overflow-hidden aspect-square cursor-pointer rounded-2xl custom-transition hover:opacity-60 w-6/12 absolute 
//                ${
//                  index === 0
//                    ? "-top-[30%] md:top-[5%] bmlg:top-0 blgxl:-top-[15%]"
//                    : index === 1
