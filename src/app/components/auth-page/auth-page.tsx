...
import SignUpForm from "./sign-up-page/sign-up-form/sign-up-form";
  ...
  return (
    <section className="flex-center min-w-screen min-h-screen relative">
      ...
      <div className="custom-container w-full">
        <div className="flex flex-col shadow-xl w-full px-4 gap-x-4 gap-y-8 max-w-[600px] mx-auto my-20 py-8 bmlg:py-4 bmlg:max-w-none bmlg:flex-row-reverse">
          {/* vector */}
          <motion.div
          ...
          <div className="w-full relative flex-center bmlg:w-[calc(50%-8px)]">
            <AnimatePresence mode="wait">
              <motion.div
                key="signup" // Unique key for animation
                variants={variants}
                initial="hidden"
                animate="visible"
                exit="exit"
